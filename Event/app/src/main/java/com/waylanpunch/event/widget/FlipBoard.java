...
public class FlipBoard extends FrameLayout implements Animation.AnimationListener, View.OnClickListener, OnFlipBoardSwipeListener {
    ...
    private OnFlipBoardSwipeTouchListener touchListener;
    ...
    private void init(Context context) {
        ...
        touchListener = new OnFlipBoardSwipeTouchListener(context);
    }
